...
**Date:** 27 Feb 2026 | **Source:** Clarification Response Matrix cross-referenced with codebase
...
| **B5** | **Overall Bengaluru / BB Revenue Split** — Policy says 15% BB, Excel gives 3.7% BB | DB apportionment gives ~96.3% Bengaluru / ~3.7% BB (derived from per-vertical rules) | Excel: BB $17.88B / KA $478.68B = 3.7% | Policy 15% vs Excel 3.7% (4x) | KDEM official BB target (website says 15%); STPI regional offices (Mysuru, Hubballi, Mangaluru); Karnataka Planning Dept GSDP composition | **KDEM policy decision** — show gap analysis: "Policy: 15% / Trajectory: 3.7% / Gap: $37B" |
| **B6** | **Bengaluru Revenue vs GSDP** — $338B Bengaluru exceeds plausible GSDP share | Revised $350B × 96.3% = $337B for Bengaluru | Excel: $460B Bengaluru (85% of projected $543B GSDP) | Both implausible | Karnataka Planning Dept (GSDP composition); RBI (city GDP estimates); NASSCOM (pass-through revenue methodology — how much is billed through Bengaluru HQs but delivered elsewhere?) | **Structural** — resolved if BB split increases to 15%. At 15% BB: Bengaluru = $298B ≈ 55% of GSDP (high but plausible given pass-through) |
| **B7** | **KA Share Percentages** — estimated, not confirmed | IT Exports 38%, IT Domestic 30%, ESDM 20% | Same estimates used | No discrepancy, but unvalidated | NASSCOM state-wise breakdown (not publicly available; request needed); STPI Karnataka (KA IT exports: ₹4.53L Cr FY25); MeitY state-wise ESDM production | **Request NASSCOM/STPI** for KA-specific figures. STPI has KA exports data (₹4.53L Cr FY25 ≈ $54.6B, implying ~24% share not 38%) |
| **B8** | **Digitizing Sectors FY25 Actuals** — no independent validation | $20.23B (KDEM Excel CAGR from FY22 McKinsey base) | Same | N/A — no alternative exists | MeitY/NASSCOM for top 5 sub-sectors (e-commerce, fintech, healthtech, edtech, agritech); IBEF sector reports; RBI digital payments data (for fintech validation) | **Confidence 2/5** — flag as estimated. CAGRs of 20-227% in Excel are unvalidated |
| **B9** | **Cluster-Level Revenue Actuals** — no actuals exist for any cluster | Targets from KDEM Vision Documents (Mysuru $10B, Mangaluru ₹40K Cr, HDB $1B) | Excel treats BB as single aggregate — no cluster breakdown | N/A | KDEM BB Program Office (per-cluster MIS); STPI regional offices; KIADB IT park occupancy rates; District Industries Centres | **Critical gap** — request KDEM BB program office for per-cluster revenue/employment MIS |
| **B10** | **Land & Capital Data** — entirely dashboard-derived, no KDEM source | Per-vertical ratios (IT 100, ESDM 33, Startups 80 sq ft/emp); construction costs (₹2,500-4,000/sq ft) | Excel has NO land or capital data | N/A — dashboard-only | JLL/CBRE India (KA-specific office space benchmarks); Knight Frank H1 2024 (Bengaluru ₹77-95/sqft/mo rental); KIADB (IT park land costs per cluster); Walls & Dreams 2025 (construction costs ₹2,000-3,500/sq ft) | **Source externally** — current values are reasonable estimates but need JLL/CBRE validation |
...
| **STPI Karnataka** | KA IT exports (₹4.53L Cr FY25) | Cross-validation of NASSCOM × share% | STPI annual report |
