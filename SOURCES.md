# Data Sources & References (Updated with Confidence Ratings)

**Last Updated:** January 15, 2026
**Purpose:** Complete attribution with confidence ratings for all data in KDEM Strategic Dashboard

---

## SOURCE CONFIDENCE RATING FRAMEWORK

| Rating | Definition | Verification Level | Dashboard Treatment |
|--------|-----------|-------------------|---------------------|
| ⭐⭐⭐⭐⭐ | **Verified Official** | Third-party government/institution data | No disclaimer |
| ⭐⭐⭐⭐ | **High Confidence** | Cross-validated from multiple sources | "Validated" tag |
| ⭐⭐⭐ | **Moderate Confidence** | Reputable research/industry reports | Source cited |
| ⭐⭐ | **Self-Reported** | Company/cluster self-reporting | "Reported" tag |
| ⭐ | **Estimated/Projected** | Calculated from methodology | "Estimated" tag |
...
| # | Source | Data Used | Confidence | Last Verified |
|---|--------|-----------|------------|---------------|
| 1 | **KDEM Official Website** (karnatakadigital.in) | Mission, verticals, program descriptions | ⭐⭐⭐⭐⭐ | Jan 2026 |
| 2 | **Beyond Bengaluru Initiative** (beyondbengaluru.com) | 126 companies, 5,500+ jobs metrics | ⭐⭐⭐⭐ | Jan 2026 |
| 3 | **Bengaluru Tech Summit** (bengalurutechsummit.com) | BTS 2025: 50,000+ visitors, 60+ countries | ⭐⭐⭐⭐⭐ | Nov 2025 |

### Karnataka Government Policies

| # | Source | Data Used | Confidence | Notes |
|---|--------|-----------|------------|-------|
| 4 | **Karnataka IT-BT Policy 2025-2030** | ₹445.5 Cr allocation, 30,000 startup target | ⭐⭐⭐⭐⭐ | Cabinet approved Dec 2025 |
| 5 | **Karnataka Startup Policy 2025-2030** | 25,000 startup target, 5% GDP goal | ⭐⭐⭐⭐⭐ | Official policy |
| 6 | **Karnataka GCC Policy 2024** | 500 GCC target, 3.5 lakh jobs, $50B output | ⭐⭐⭐⭐⭐ | Notified policy |
| 7 | **Karnataka Space Tech Policy 2025** | Policy launch announcement | ⭐⭐⭐⭐⭐ | BTS 2025 |
| 8 | **Karnataka ER&D Policy 2021** | 40% of India's ER&D revenue | ⭐⭐⭐⭐ | Official policy |
| 9 | **Karnataka Aerospace & Defence Policy 2022-27** | 60-65% of India's aerospace | ⭐⭐⭐⭐⭐ | Official policy |

### Regional Government Data

| # | Source | Data Used | Confidence | Notes |
|---|--------|-----------|------------|-------|
| 10 | **STPI Karnataka** (bengaluru.stpi.in) | IT/ITES exports (45% share) | ⭐⭐⭐⭐⭐ | Official quarterly data |
| 11 | **DPIIT** | Karnataka #1 state, 16,000+ startups | ⭐⭐⭐⭐⭐ | Government of India |
| 12 | **Karnataka Economic Survey** | Digital economy ~$110B estimate | ⭐⭐⭐⭐ | State economic data |
...
|---|--------|-----------|------------|------|
| 13 | **Zinnov "5 Shifts Defining India's GCC Story in 2025"** | 1,800+ GCCs, 2M workforce, Karnataka 880+ centers | ⭐⭐⭐⭐ | Nov 2025 |
| 14 | **Zinnov-NASSCOM Mid-market GCC Report 2025** | 480+ mid-market centers, 27% of India GCCs | ⭐⭐⭐⭐ | 2025 |
| 15 | **Zinnov-KDEM Karnataka Mid-market Report** | Nearly half of India's mid-market GCCs in Karnataka | ⭐⭐⭐⭐ | 2025 |
| 16 | **Zinnov Mega GCC Report 2025** | 5% of GCCs = 50% workforce | ⭐⭐⭐⭐ | 2025 |
| 17 | **Zinnov Tier-I City Analysis 2025** | Bengaluru 880+, Hyderabad 355+ | ⭐⭐⭐⭐ | 2025 |
| 18 | **NASSCOM GCC State Policies Analysis** | Policy comparison across states | ⭐⭐⭐⭐ | Nov 2025 |
| 19 | **STPI GCC Policy Report** | $50B→$110B market projection (14% CAGR) | ⭐⭐⭐⭐ | 2025 |

### Startup & Ecosystem Research

| # | Source | Data Used | Confidence | Date |
|---|--------|-----------|------------|------|
| 20 | **Startup Genome - Bengaluru Karnataka** | Ecosystem health metrics | ⭐⭐⭐⭐ | 2025 |
| 21 | **Tracxn** | Startup funding, unicorn tracking | ⭐⭐⭐ | Subscription data |
| 22 | **Inc42** | Startup news, BTS coverage | ⭐⭐⭐ | News source |

### Competitive Intelligence

| # | Source | Data Used | Confidence | Date |
|---|--------|-----------|------------|------|
| 23 | **Outlook Business Year Ender 2025** | Karnataka vs Telangana cost comparison | ⭐⭐⭐⭐ | Dec 2025 |
| 24 | **Dun & Bradstreet Hyderabad 2025** | Hyderabad 355+ GCCs, 70 greenfield | ⭐⭐⭐⭐ | 2025 |

---

## CLUSTER VISION DOCUMENTS

| # | Source | Data Used | Confidence | Release Date |
|---|--------|-----------|------------|--------------|
...
| # | Source | Data Used | Confidence | Date |
|---|--------|-----------|------------|------|
| 30 | **TheHansIndia - Mysuru Big Tech Show** | 80+ startups, 1,100+ delegates | ⭐⭐⭐ | Jul 2025 |
| 31 | **Daijiworld - Mangaluru Technovanza** | Vision document unveiling, metrics | ⭐⭐⭐ | Sep 2025 |
| 32 | **Inc42 - BTS 2025 Coverage** | DeepTech, AI focus | ⭐⭐⭐ | Nov 2025 |

---

## INTERNATIONAL BENCHMARKS (NEW)
...
## SELF-REPORTED DATA (LOWER CONFIDENCE)
...
|-----|---------------|-----------------|----------|
| Company-level verification | Self-reported | Registry system + EPFO linkage | HIGH |
| Event conversion tracking | None | Event CRM implementation | HIGH |
| Cluster progress validation | Informal | Standardized templates | HIGH |
| ELEVATE alumni outcomes | Partial | Alumni tracking system | MEDIUM |
| Competitive cost data | Ad-hoc | Regular benchmarking | MEDIUM |
| Digital economy methodology | Estimated | Statistical office partnership | LOW |

---

## UPDATE SCHEDULE

| Data Category | Frequency | Next Update | Owner |
|---------------|-----------|-------------|-------|
| Vision Progress | Quarterly | April 2026 | Strategy |
| Beyond Bengaluru Metrics | Monthly | Feb 2026 | Clusters |
| Program Data (ELEVATE/LEAP) | Quarterly | April 2026 | Innovation |
| Competitive Intelligence | Quarterly | April 2026 | Strategy |
| External Partnerships Data | Monthly | Feb 2026 | Data Team |
| International Benchmarks | Semi-annually | July 2026 | Strategy |
...
1. Identify primary source (official > research > news)
2. Cross-validate with 2+ sources where possible
3. Assign confidence rating per framework
4. Document methodology for estimates
5. Note verification date
6. Flag for periodic re-verification

### For Dashboard Publication:
1. All Level 1-2 confidence data: Publish directly
2. Level 3 data: Include source citation
3. Level 4-5 data: Include "Reported" or "Estimated" tag
4. Aspirational targets: Clear "Target" label
